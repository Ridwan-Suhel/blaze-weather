...
const HourlyCard = ({ data, unitActiveClass, timeZone }) => {
  return (
    <div className="border border-slate-500 transition-all duration-500 md:w-[150px] card p-4 rounded-lg shadow text-center bg-white dark:bg-slate-900 dark:shadow-slate-500 dark:text-slate-300">
