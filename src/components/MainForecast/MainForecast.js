...
const MainForecast = () => {
  ...
  const url = `https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=2199f6775906f518de6705db5a71c1b8`;
  ...
  return (
    <aside className="main-forecast w-1/4 bg-white shadow min-h-screen rounded">
      ...
      <div className="forecast-detail px-4 mt-5">
        <h2 className="text-5xl font-light">
          24&deg;<span className="text-3xl">C</span>
        </h2>

        <h2 className="text-2xl font-normal my-6">
          Saturday, <span className="text-slate-500 font-light">12:29 AM</span>
        </h2>

        <div className="more-info text-slate-500">
          <div className="flex items-center gap-3">
            <BeakerIcon className="h-5 w-5" /> <span>Feels Like 26&deg;C</span>
          </div>
          <div className="flex items-center gap-3">
